...
?>
		...
		?>			
				<tr class="<? echo $cl?>">
					...
					<td width="2%" align="center">
						<img style="cursor:pointer" title="Edit Menu" src="<? echo $bit_app["path_url"]?>/bit_images/edit.gif" onClick="var win; win=window.open('<? echo $bit_app["path_url"]."/bit_content/content/"?>sMenuEdit3.php?id=<? echo $rs->value[$i][1]?>','win','top=130,left=100,height=450,width=600,resizable=1,scrollbars=1');win.focus()">
					</td>
					<td width="2%" align="center">
	...
	&nbsp;
	<? $f->button("add","Tambah SubMenu","button","var win;win=window.open('".$bit_app["path_url"]."/bit_content/content/sMenuAdd3.php?id=".$_GET["id"]."','win','top=120,left=100,height=350,width=700,resizable=1,scrollbars=1');win.focus()")?>
	&nbsp;
