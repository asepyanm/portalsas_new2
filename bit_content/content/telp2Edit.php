...
<?
	...
	$ora=new clsMysql;
		...
		$qry="select * from m_telp_pejabat_telkom where id=".$_GET["id"];
...
<table width="100%">
	...
	<tr>
		...
		<td><? $f->textbox("tNIK","tNIK",$_POST["tNIK"],"inputBox",20,255)?>&nbsp;</td>
	</tr>
	<tr>
		<td valign="top">Jabatan</td>
		<td><? $f->textbox("tJabatan","tJabatan",$_POST["tJabatan"],"inputBox",50,255)?>&nbsp;</td>
	</tr>
	<tr>
		<td valign="top">Loker</td>
		<td><? $f->textbox("tLoker","tLoker",$_POST["tLoker"],"inputBox",50,255)?>&nbsp;</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><? $f->textbox("tFlexi","tFlexi",$_POST["tFlexi"],"inputBox",20,255)?>&nbsp;</td>
	</tr>
	<tr>
		<td colspan="2">
			<b>Ket :</b>
...
<?
	...
	if ($_POST["ok"]) {
		...
		$qry="update m_telp_pejabat_telkom
				set 
					nama='".$_POST["tNama"]."',
					nik='".$_POST["tNIK"]."',
