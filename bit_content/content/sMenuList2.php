...
?>
	...
	<tbody>
		...
		?>			
				<tr class="<? echo $cl?>">
					...
					<td align="center" width="8%"><a href="#" onClick="var xWinSubMenu1;xWinSubMenu1=window.open('<? echo $bit_app["path_url"]."/bit_content/content/"?>sMenuList3.php?id=<? echo $rs->value[$i][1]?>&mn=<? echo $rs->value[$i][2]?>','xWinSubMenu1','top=140,left=100,width=870,height=400,scrollbars=1,resizable=1');xWinSubMenu1.focus()">edit Sub Menu</a></td>
					<td width="2%" align="center">
						<img style="cursor:pointer" title="Edit Menu" src="<? echo $bit_app["path_url"]?>/bit_images/edit.gif" onClick="var win; win=window.open('<? echo $bit_app["path_url"]."/bit_content/content/"?>sMenuEdit2.php?id=<? echo $rs->value[$i][1]?>','win','top=130,left=100,height=450,width=600,resizable=1,scrollbars=1');win.focus()">
					</td>
					<td width="2%" align="center">
	...
	&nbsp;
	<? $f->button("add","Tambah SubMenu","button","var win;win=window.open('".$bit_app["path_url"]."/bit_content/content/sMenuAdd2.php?id=".$_GET["id"]."','win','top=120,left=100,height=350,width=700,resizable=1,scrollbars=1');win.focus()")?>
	&nbsp;
