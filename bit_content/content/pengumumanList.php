...
?>
	...
	<tr>
		<td colspan="5">
			<? echo setTitleCari("Running Text");?>
		</td>
	</tr>
	</table>
		...
		?>			
				<tr class="<? echo $cl?>">
					...
					<td width="1%" align="center">
						<img style="cursor:pointer" title="Edit Running Text" src="<? echo $bit_app["path_url"]?>/bit_images/edit.gif" onClick="var win; win=window.open('<? echo $bit_app["path_url"]."/bit_content/content/"?>pengumumanEdit.php?id=<? echo $rs->value[$i][1]?>','win','top=10,left=100,height=570,width=600,resizable=1,scrollbars=1');win.focus()">
					</td>
					<td width="1%" align="center">
						<img style="cursor:pointer" title="Delete Running Text" src="<? echo $bit_app["path_url"]?>/bit_images/hapus.png" onClick="var ans;ans=confirm('Anda yakin untuk menghapus ?'); if (ans) {document.forms[0].hdAction.value=3;document.forms[0].id.value=<? echo $rs->value[$i][1]?>;document.forms[0].submit();}">
					</td>
				</tr>	
		<? } ?>
	</tbody>
	...
	<p align="right">
	<? $f->button("add","Tambah","button","var win;win=window.open('".$bit_app["path_url"]."/bit_content/content/pengumumanAdd.php','win','top=10,left=100,height=570,width=600,resizable=1,scrollbars=1');win.focus()")?>
	&nbsp;
