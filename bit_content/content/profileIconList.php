...
?>
	...
	<tr>
		<td colspan="5">
			<? echo setTitleCari("Profile Menu Icon");?>
		</td>
	</tr>
	</table>
	...
	<tbody>
		...
		?>			
				<tr class="<? echo $cl?>">
					...
					<td width="1%">
						<img title="Edit Data" src="<? echo $bit_app["path_url"]?>/bit_images/edit.gif" onMouseOver="this.style.cursor='pointer'" onClick="var win; win=window.open('<? echo $bit_app["path_url"]."/bit_content/content/"?>profileIconEdit.php?id=<? echo $rs->value[$i][1]?>','win','top=10,left=100,height=550,width=600,resizable=1,scrollbars=1');win.focus()">
					</td>
					<td width="1%">
	...
	<p align="right">
	<? $f->button("add","Tambah","button","var win;win=window.open('".$bit_app["path_url"]."/bit_content/content/profileIconAdd.php','win','top=10,left=100,height=550,width=600,resizable=1,scrollbars=1');win.focus()")?>
	&nbsp;
