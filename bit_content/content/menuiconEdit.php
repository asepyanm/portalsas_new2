...
<?
	...
	$qry="select menu_name,tipe_content,content,target,icon from menu_icon where menu_id=".$_GET["id"];
...
<table  width="100%">
	...
	<tr>
		...
		<?
			if ($rs->value[1][5])
				echo "<a target='_blank' href='../../bit_folder/".$rs->value[1][5]."'>".$rs->value[1][5]."</a><br>";
		?>
