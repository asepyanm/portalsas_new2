...
?>
	...
	<tbody>
		...
		?>			
				<tr class="<? echo $cl?>">
					...
					<td width="1%" align="center">
						<img title="Edit Banner" style="cursor:pointer" src="<? echo $bit_app["path_url"]?>/bit_images/edit.gif" onClick="var win; win=window.open('<? echo $bit_app["path_url"]."/bit_content/banner/"?>edit.php?id=<? echo $rs->value[$i][1]?>','win','top=10,left=100,height=400,width=600,resizable=1,scrollbars=1');win.focus()">
					</td>
				</tr>	
		<? } ?>
	</tbody>
	...
	<hr class="article_layout_hr">
	<p align="right">
	<? $f->button("add","Tambah","button","var win;win=window.open('".$bit_app["path_url"]."/bit_content/content/bannerAdd.php','win','top=10,left=100,height=400,width=600,resizable=1,scrollbars=1');win.focus()")?>
