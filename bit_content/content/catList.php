...
?>
	...
	<tr>
		<td colspan="5">
			<? echo setTitleCari("Daftar Kategori");?>
		</td>
	</tr>
	</table>
	...
	<tbody>
		...
		?>			
				<tr class="<? echo $cl?>">
					...
					<td width="1%">
						<img title="Edit Kategori" style="cursor:pointer" src="<? echo $bit_app["path_url"]?>/bit_images/edit.gif" onClick="var win; win=window.open('<? echo $bit_app["path_url"]."/bit_content/content/"?>catEdit.php?id=<? echo $rs->value[$i][1]?>','win','top=10,left=100,height=250,width=600,resizable=1,scrollbars=1');win.focus()">
					</td>
					<td width="1%">
	...
	<p align="right">
	<? $f->button("add","Tambah","button","var win;win=window.open('".$bit_app["path_url"]."/bit_content/content/catAdd.php','win','top=10,left=100,height=250,width=600,resizable=1,scrollbars=1');win.focus()")?>
	&nbsp;
