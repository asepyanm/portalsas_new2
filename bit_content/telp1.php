...
?>
	...
	<tr>
		<td colspan="5">
			<? echo setTitle("Nomor Telepon Personil SAS");?>
		</td>
	</tr>
	</table>
	<table cellpadding="1" cellspacing="0">
		<tr>
			<td align="right">
				Cari : <input type="text" name="tSearch" size="30"  value="<? if ($_POST["tSearch"]) echo $_POST["tSearch"]; else echo "Search"?>" onMouseOver="if (this.value=='Search') this.value=''" onMouseOut="if (this.value=='') this.value='Search'">
	...
	<tbody>
		<?
			...
			//=============================================
			$qry="select 
					id,nama,nik,jabatan,loker,area,kantor,hp,flexi
