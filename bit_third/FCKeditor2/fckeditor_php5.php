	...
	public function __construct( $instanceName )
 	{
		...
		//$this->BasePath		= $gHomePageUrl . 'javascripts/fckeditor/' ;
		//$this->BasePath		= $bit_app["path_url"] . 'bit_third/FCKeditor2/';
		$this->BasePath		= $gHomePageUrl . 'bit_third/FCKeditor2/';
		//$this->BasePath		= 'https://localhost/portalsas_new/bit_third/FCKeditor2/';
		$this->Width		= '100%' ;
		$this->Height		= '200' ;
