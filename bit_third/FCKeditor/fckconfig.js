...
FCKConfig.StylesXmlPath		= FCKConfig.EditorPath + 'fckstyles1.xml' ;
...
FCKConfig.LinkBrowserWindowWidth  = 640 //FCKConfig.ScreenWidth * 0.7 ;	// 70% ;
FCKConfig.LinkBrowserWindowHeight = 400 //FCKConfig.ScreenHeight * 0.7 ;	// 70% ;

FCKConfig.ImageBrowser = true ;
FCKConfig.ImageBrowserURL = FCKConfig.BasePath + 'filemanager/browser/default/browser.html?Type=Image&Connector=connectors/' + _FileBrowserLanguage + '/connector.' + _FileBrowserExtension ;
FCKConfig.ImageBrowserWindowWidth  = 640 //FCKConfig.ScreenWidth * 0.7 ;	// 70% ;
FCKConfig.ImageBrowserWindowHeight = 400 //FCKConfig.ScreenHeight * 0.7 ;	// 70% ;

FCKConfig.FlashBrowser = true ;
FCKConfig.FlashBrowserURL = FCKConfig.BasePath + 'filemanager/browser/default/browser.html?Type=Flash&Connector=connectors/' + _FileBrowserLanguage + '/connector.' + _FileBrowserExtension ;
FCKConfig.FlashBrowserWindowWidth  = 640 //FCKConfig.ScreenWidth * 0.7 ;	// 70% ;
FCKConfig.FlashBrowserWindowHeight = 400 //FCKConfig.ScreenHeight * 0.7 ;	// 70% ;
...
FCKConfig.LinkUploadAllowedExtensions	= ".(doc|pdf|txt|xls|zip|rar|tar|gz|tar.gz)$" ;			// empty for all
