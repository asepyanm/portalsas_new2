...
FCKConfig.BaseHref = 'http://www.paramartha.org' ;
...
//Added by ZAE
FCKConfig.UseSession    = false;
FCKConfig.SessionName   = '';
FCKConfig.SessionID     = '';
FCKConfig.AdminLevel    = 0;

FCKConfig.Footnote      = false ;
FCKConfig.FootnoteID    = 'olfootnotes' ;
FCKConfig.FootnoteStart = 1;

FCKConfig.ContentBrowserURL = '../../../../js_fck_content.php';
FCKConfig.ContentRedirectURL = 'redirect_content.php' ;
//End Added by Zae
...
FCKConfig.ToolbarSets["Default"] = [
	['SelectAll','RemoveFormat'],['Cut','Copy','PasteWord','-','Undo','Redo'],
	['Bold','Italic','Underline']
] ;

FCKConfig.ToolbarSets["Article"] = [
	['SelectAll','RemoveFormat'],['Cut','Copy','PasteWord','PasteText','-','Undo','Redo'],
	['Table','-','Image'],
...
FCKConfig.FontFormats	= 'p;h3;h4;h5;h6;div;pre';
...
FCKConfig.ImageBrowserWindowWidth  = 640 ;	// 70% ;
...
FCKConfig.LinkUploadAllowedExtensions	= ".(doc|xls|zip|rar)$" ;			// empty for all
